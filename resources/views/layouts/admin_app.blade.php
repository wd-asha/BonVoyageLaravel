...
<head>
    ...
    <title>BonVoyage - Административная панель</title>
...
<!-- ########## START: LEFT PANEL ########## -->
<div class="sl-logo"><a href="{{ URL('/') }}">BonVoyage</a></div>
<div class="sl-sideleft">
    ...
    <div class="sl-sideleft-menu">
        ...
        <a href="{{ route('admin.countries') }}" class="sl-menu-link">
            <div class="sl-menu-item">
                <i class="fa fa-globe tx-20"></i>
                <span class="menu-item-label">Страны</span>
            </div>
        </a>
        ...
        <a href="#" class="sl-menu-link">
            <div class="sl-menu-item">
                <i class="fa fa-fort-awesome tx-20"></i>
                <span class="menu-item-label">Отели</span>
                <i class="menu-item-arrow fa fa-angle-down"></i>
            </div><!-- menu-item -->
        </a><!-- sl-menu-link -->

        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('admin.hotels') }}" class="nav-link">Все отели</a></li>
            <li class="nav-item"><a href="{{ route('hotel.create') }}" class="nav-link">Новый отель</a></li>
        </ul>

        <a href="#" class="sl-menu-link">
            <div class="sl-menu-item">
                <i class="fa fa-hotel tx-20"></i>
                <span class="menu-item-label">Предложения</span>
                <i class="menu-item-arrow fa fa-angle-down"></i>
            </div><!-- menu-item -->
        </a><!-- sl-menu-link -->

        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('admin.departures') }}" class="nav-link">Все предложения</a></li>
            <li class="nav-item"><a href="{{ route('departure.create') }}" class="nav-link">Новое предложение</a></li>
        </ul>
