...
<head>
    ...
    <link href="{{asset('css/countris.css')}}" rel="stylesheet">
...
<script>
    $(document).ready(function(){
        $('#pagin-1').click(function(){
            ...
            $('#pagin-2, #pagin-3, #pagin-4').removeClass('carrent');
            $('#slide-2').hide();
            $('#slide-3').hide();
            $('#slide-4').hide();
        ...
        $('#pagin-2').click(function(){
            $(this).addClass('carrent');
            $('#pagin-1, #pagin-3, #pagin-4').removeClass('carrent');
            $('#slide-1').hide();
            $('#slide-3').hide();
            $('#slide-4').hide();
        ...
        $('#pagin-3').click(function(){
            $(this).addClass('carrent');
            $('#pagin-1, #pagin-2, #pagin-4').removeClass('carrent');
            $('#slide-1').hide();
            $('#slide-2').hide();
            $('#slide-4').hide();
        ...
        $('#pagin-4').click(function(){
            $(this).addClass('carrent');
            $('#pagin-1, #pagin-2, #pagin-3').removeClass('carrent');
            $('#slide-1').hide();
            $('#slide-2').hide();
            $('#slide-3').hide();
