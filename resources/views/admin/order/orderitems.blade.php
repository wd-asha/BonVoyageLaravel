        ...
        <div class="table-responsive col-md-10">
            ...
            <table class="table table-hover table-bordered mg-b-0 mb-5">
                ...
                <tr>
                    ...
                    <th class="wd-16p">Страна</th>
                    <th class="wd-16p">Город</th>
                    <th class="wd-16p">Отель</th>
                    <th class="wd-16p">Вместимость</th>
                    <th class="wd-16p">Стандарт</th>
                    <th class="wd-16p">Дни</th>
                ...
                @foreach($orderItems as $item)
                    <tr>
                        ...
                        <td>{{ $item->departure_country }}</td>
                        <td>{{ $item->departure_town }}</td>
                        <td>{{ $item->departure_hotel }}</td>
                        <td>{{ $item->departure_seats }}</td>
                        <td>{{ $item->departure_standard }}</td>
                        <td>{{ $item->departure_days }}</td>
                        {{--<td>{{ $item->departure_price }}</td>--}}
                        <td>{{ number_format($item->departure_price, 0, '.', ' ' ) }}</td>
                    </tr>
                @endforeach
